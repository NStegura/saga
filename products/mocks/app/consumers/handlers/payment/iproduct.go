...
// Source: internal/app/consumers/handlers/payment/iproduct.go
...
// UpdateReserveStatus mocks base method.
func (m *MockProduct) UpdateReserveStatus(ctx context.Context, orderID int64, status bool) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateReserveStatus", ctx, orderID, status)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateReserveStatus indicates an expected call of UpdateReserveStatus.
func (mr *MockProductMockRecorder) UpdateReserveStatus(ctx, orderID, status interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateReserveStatus", reflect.TypeOf((*MockProduct)(nil).UpdateReserveStatus), ctx, orderID, status)
}
