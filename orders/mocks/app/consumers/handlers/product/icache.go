...
// Source: internal/app/consumers/handlers/product/icache.go
...
func (m *MockCache) Get(arg0 context.Context, arg1 uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (m *MockCache) Set(arg0 context.Context, arg1 uuid.UUID) error {
	m.ctrl.T.Helper()
